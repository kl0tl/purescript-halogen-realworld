...
var sum = function (dictGeneric) {
    return function (dictGRouteDuplex) {
        var $2789 = Data_Profunctor.dimap(Routing_Duplex.profunctorRouteDuplex)(Data_Generic_Rep.from(dictGeneric))(Data_Generic_Rep.to(dictGeneric));
        var $2790 = gRouteDuplex(dictGRouteDuplex);
        return function ($2791) {
            return $2789($2790($2791));
        };
    };
};
