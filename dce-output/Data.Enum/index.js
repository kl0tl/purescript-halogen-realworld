        ...
        return function (high) {
            return function (x) {
                ...
                if (v instanceof Data_Maybe.Nothing) {
                    var $1198 = x < fromEnum(dictBoundedEnum)(Data_Bounded.bottom(dictBoundedEnum.Bounded0()));
                    if ($1198) {
                        return low;
                    };
                    return high;
...
var enumInt = new Enum(function ($dollar__unused) {
    ...
    var $1199 = n > Data_Bounded.bottom(Data_Bounded.boundedInt);
    if ($1199) {
        return new Data_Maybe.Just(n - 1 | 0);
    };
    return Data_Maybe.Nothing.value;
}, function (n) {
    var $1200 = n < Data_Bounded.top(Data_Bounded.boundedInt);
    if ($1200) {
        return new Data_Maybe.Just(n + 1 | 0);
    };
    return Data_Maybe.Nothing.value;
