...
var foldableList = new Data_Foldable.Foldable(function (dictMonoid) {
    return function (f) {
        return Data_Foldable.foldl(foldableList)(function (acc) {
            var $1355 = Data_Semigroup.append(dictMonoid.Semigroup0())(acc);
    ...
    return function (b) {
        ...
        var $1357 = Data_Foldable.foldl(foldableList)(Data_Function.flip(f))(b);
        return function ($1358) {
            return $1357(rev($1358));
        };
    };
});
