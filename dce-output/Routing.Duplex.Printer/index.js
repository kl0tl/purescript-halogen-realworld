...
var run = (function () {
    var $2943 = Data_Function.applyFlipped(Routing_Duplex_Types.emptyRouteState);
    var $2944 = Data_Newtype.unwrap(newtypeRoutePrinter);
    return function ($2945) {
        return printPath($2943($2944($2945)));
    };
})();
