...
var formatterCommandParser = Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Data_Formatter_Parser_Utils.oneOfAs(Data_Functor.functorArray)(Data_Foldable.foldableArray)(Data_Identity.monadIdentity)((function () {
    var $1262 = Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity);
    var $1263 = Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity);
...
var formatCommand = function (v) {
    return function (v1) {
        ...
        if (v1 instanceof Meridiem) {
            var $1258 = Data_Enum.fromEnum(Data_Time_Component.boundedEnumHour)(Data_Time.hour(v.value1)) >= 12;
            if ($1258) {
                return "PM";
            };
            return "AM";
